...
It's perfectly fine to re-use this definition in the geomaster application,
though.
"""
import os
from datetime import datetime
from hashlib import sha256
__all__ = ['User', 'Group', 'Permission', 'GeoMaster']

from ming import schema as s
from ming.odm import FieldProperty, ForeignIdProperty, RelationProperty
from ming.odm import Mapper
from ming.odm.declarative import MappedClass
from geomaster.model import DBSession

class GeoMaster(MappedClass):
    """
    GeoMaster definition.
    """
    class __mongometa__:
        session = DBSession
        name = 'geomaster'
